...
# 
# setwd("~/Desktop/Samarth/Hopkins/Hopkins-Classwork/Data_Science/Project/flight-delays")
...
# airline_share <- read.csv(curl("https://raw.githubusercontent.com/apatel3112/Flight-Delays/master/airline_share.csv"))
# airports_data <- read.csv(curl("https://raw.githubusercontent.com/apatel3112/Flight-Delays/master/airports_data_fixed.csv"))
# busiest_airpots <- read.csv(curl("https://raw.githubusercontent.com/apatel3112/Flight-Delays/master/busiest_airpots.csv"))
# cancelled_flights <- read.csv(curl("https://raw.githubusercontent.com/apatel3112/Flight-Delays/master/cancelled_flights.csv"))
# train_data <- read.csv(curl("https://raw.githubusercontent.com/apatel3112/Flight-Delays/master/train_data_reduced.csv"))
...
# all_flights_data <- read.csv("merged_flights.csv")
```
...
<!-- The below plot visualizes all flights from JFK to all other destinations! -->
...
usairports <- dplyr::filter(airports_data, IATA_CODE!="JFK") #filter out jfk
jfk <- dplyr::filter(airports_data, IATA_CODE=="JFK") #separate df for jfk
...
```{r}
# fig <- plot_ly(airline_share, x = ~Airline, y = ~Number_Of_Flights, type = 'bar')
# fig <- fig %>% layout(title = "Airline Market Share",
#          xaxis = list(title = "", tickangle = 45, size = 5),
#          yaxis = list(title = ""))
...
# write.csv(split_data, "split_data.csv")
# del split_data

# fig <- plot_ly( x = name1, y = name2, type = 'bar')
# fig <- fig %>% layout(title = "Reasons for Calcellation of flights",
#          xaxis = list(title = "", tickangle = 45, size = 1),
#          yaxis = list(title = "Count"))
